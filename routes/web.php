...
// Main Page Route
Route::get('/', $controller_path . '\web\HomeController@index')->name('dashboard-analytics');
Route::get('/dashboard/analytics', $controller_path . '\dashboard\Analytics@index')->name('dashboard');
