...
@section('page-style')
<link rel="stylesheet" href="{{asset('assets/vendor/css/pages/app-kabani.css')}}" />
@endsection
...
<script src="{{asset('assets/vendor//libs/jkanban/jkanban-editado2.js')}}"></script>
<script src="{{asset('assets/vendor//libs/quill/katex.js')}}"></script>
<script src="{{asset('assets/vendor//libs/quill/quill.js')}}"></script>
@endsection

@section('page-script')
<script src="{{asset('assets/js/app-kabani2.js')}}"></script>
@endsection

@section('content')
  <div class="app-kanban">

  <div class="alert alert-success alert-dismissible align-items-baseline kanban-alert-status-success" role="alert">
    <span class="alert-icon alert-icon-lg text-primary me-2">
      <i class="ti ti-award ti-sm"></i>
    </span>
    <div class="d-flex flex-column ps-1">
      <h5 class="alert-heading mb-2">Tarea actualizada</h5>
      <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close">
      </button>
    </div>
  </div>
  <div class="alert alert-success alert-dismissible align-items-baseline kanban-alert-remove-success" role="alert">
    <span class="alert-icon alert-icon-lg text-primary me-2">
      <i class="ti ti-award ti-sm"></i>
    </span>
    <div class="d-flex flex-column ps-1">
      <h5 class="alert-heading mb-2">Tarea eliminada correctamente</h5>
      <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close">
      </button>
    </div>
  </div>
        ...
        <div class="tab-pane fade show active" id="tab-update" role="tabpanel">
          <form>
            ...
            <div class="mb-3" style="display: none;">
              <input type="hidden" id="kanban_id" class="form-control" placeholder="Enter Title" />
            </div>
            <div class="mb-3">
